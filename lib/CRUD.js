...
class CRUD {
    ...
    async create() {
        ...
        var result = await promiseQuery(sql, [this.table, this.columns, this.data, this.sqlSwitch])
        return result;
    }
    ...
    async read() {
        ...
        var result = await promiseQuery(sql, [this.columns, this.table, this.sqlSwitch])
        return result;
    };
